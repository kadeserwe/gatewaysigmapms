...
import { IPlanPassation, PlanPassation } from '../../../shared/model/planpassationms/plan-passation.model';
...
@Component({
  selector: 'jhi-plan-passation-demande-validation',
  templateUrl: './plan-passation-demande-validation.component.html',
})
export class PlanPassationDemandeValidationComponent implements OnInit {
  ...
  anneePlan: any;
  etatPlan = 'En cours de validation';
