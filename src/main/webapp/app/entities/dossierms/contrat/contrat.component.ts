...
export class ContratComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.contratService
      ...
      .subscribe(
        (res: HttpResponse<IContrat[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInContrats(): void {
    this.eventSubscriber = this.eventManager.subscribe('contratListModification', () => this.loadPage());
  }
