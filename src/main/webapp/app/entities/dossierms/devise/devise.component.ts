...
export class DeviseComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.deviseService
      ...
      .subscribe(
        (res: HttpResponse<IDevise[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInDevises(): void {
    this.eventSubscriber = this.eventManager.subscribe('deviseListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IDevise[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
