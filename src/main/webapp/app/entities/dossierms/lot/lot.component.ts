...
export class LotComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.lotService
      ...
      .subscribe(
        (res: HttpResponse<ILot[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInLots(): void {
    this.eventSubscriber = this.eventManager.subscribe('lotListModification', () => this.loadPage());
  }
