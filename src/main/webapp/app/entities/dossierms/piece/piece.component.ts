...
export class PieceComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.pieceService
      ...
      .subscribe(
        (res: HttpResponse<IPiece[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInPieces(): void {
    this.eventSubscriber = this.eventManager.subscribe('pieceListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IPiece[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
