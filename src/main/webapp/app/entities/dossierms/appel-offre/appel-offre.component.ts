...
export class AppelOffreComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.appelOffreService
      ...
      .subscribe(
        (res: HttpResponse<IAppelOffre[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  ngOnInit(): void {
    ...
    this.registerChangeInAppelOffres();
  }
  ...
  registerChangeInAppelOffres(): void {
    this.eventSubscriber = this.eventManager.subscribe('appelOffreListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IAppelOffre[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
