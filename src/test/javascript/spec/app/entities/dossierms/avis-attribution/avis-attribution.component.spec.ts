...
import { AvisAttributionComponent } from 'app/entities/dossierms/avis-attribution/avis-attribution.component';
...
describe('Component Tests', () => {
  describe('AvisAttribution Management Component', () => {
    let comp: AvisAttributionComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AvisAttributionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.avisAttributions && comp.avisAttributions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
