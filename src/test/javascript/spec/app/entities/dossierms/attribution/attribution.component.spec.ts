...
import { AttributionComponent } from 'app/entities/dossierms/attribution/attribution.component';
...
describe('Component Tests', () => {
  describe('Attribution Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AttributionComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.attributions && comp.attributions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
