...
To build the final jar and optimize the gatewaysigmap application for production, run:
...
Then navigate to [http://localhost:7071](http://localhost:7071) in your browser.
